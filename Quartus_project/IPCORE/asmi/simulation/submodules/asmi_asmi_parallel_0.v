//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DATA_WIDTH="QUAD" DEVICE_FAMILY="Stratix V" ENABLE_SIM="FALSE" EPCS_TYPE="EPCQ256" FLASH_RSTPIN="FALSE" PAGE_SIZE=256 PORT_BULK_ERASE="PORT_USED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_USED" PORT_EX4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_USED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_USED" PORT_READ_ADDRESS="PORT_UNUSED" PORT_READ_DUMMYCLK="PORT_UNUSED" PORT_READ_RDID="PORT_USED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_USED" PORT_SECTOR_ERASE="PORT_UNUSED" PORT_SECTOR_PROTECT="PORT_UNUSED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="ON" USE_EAB="ON" WRITE_DUMMY_CLK=0 addr bulk_erase busy clkin data_valid datain dataout en4b_addr fast_read illegal_erase illegal_write rden rdid_out read_rdid read_status reset shift_bytes status_out wren write INTENDED_DEVICE_FAMILY="Stratix V" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
//VERSION_BEGIN 16.0 cbx_a_gray2bin 2016:04:20:18:35:29:SJ cbx_a_graycounter 2016:04:20:18:35:29:SJ cbx_altasmi_parallel 2016:04:20:18:35:29:SJ cbx_altdpram 2016:04:20:18:35:29:SJ cbx_altera_syncram 2016:04:20:18:35:29:SJ cbx_altera_syncram_nd_impl 2016:04:20:18:35:29:SJ cbx_altsyncram 2016:04:20:18:35:29:SJ cbx_arriav 2016:04:20:18:35:27:SJ cbx_cyclone 2016:04:20:18:35:29:SJ cbx_cycloneii 2016:04:20:18:35:29:SJ cbx_fifo_common 2016:04:20:18:35:29:SJ cbx_lpm_add_sub 2016:04:20:18:35:29:SJ cbx_lpm_compare 2016:04:20:18:35:29:SJ cbx_lpm_counter 2016:04:20:18:35:29:SJ cbx_lpm_decode 2016:04:20:18:35:29:SJ cbx_lpm_mux 2016:04:20:18:35:29:SJ cbx_mgl 2016:04:20:19:36:45:SJ cbx_nadder 2016:04:20:18:35:29:SJ cbx_nightfury 2016:04:20:18:35:28:SJ cbx_scfifo 2016:04:20:18:35:29:SJ cbx_stratix 2016:04:20:18:35:29:SJ cbx_stratixii 2016:04:20:18:35:29:SJ cbx_stratixiii 2016:04:20:18:35:29:SJ cbx_stratixv 2016:04:20:18:35:29:SJ cbx_util_mgl 2016:04:20:18:35:29:SJ cbx_zippleback 2016:04:20:18:35:29:SJ  VERSION_END
...
//synthesis_resources = a_graycounter 4 lpm_compare 2 lpm_counter 2 lut 29 mux21 19 reg 188 stratixv_asmiblock 1 
...
`endif
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  buf_empty_reg <= wire_cmpr12_aeb;
	// synopsys translate_off
	initial
		bulk_erase_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_end_rbyte_reg_ena = ((wire_mux219_dataout | clr_endrbyte_wire) | addr_overdie),
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  max_cnt_reg <= wire_cmpr11_aeb;
	// synopsys translate_off
	initial
		maxcnt_shift_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_pgwrbuf_dataout_d = {(({7{read_bufdly}} & wire_scfifo10_q[7:1]) | ({7{(~ read_bufdly)}} & pgwrbuf_dataout[6:0])), (read_bufdly & wire_scfifo10_q[0])};
	assign
	...
	assign
		wire_pgwrbuf_quad_dataout_d = {(({4{read_bufdly}} & wire_scfifo10_q[7:4]) | ({4{(~ read_bufdly)}} & pgwrbuf_quad_dataout[3:0])), ({4{read_bufdly}} & wire_scfifo10_q[3:0])};
	assign
 ...
 & addr_reg_overdie[12])), (((not_busy & addr[11]) | (stage3_wire & quad_addr_reg[7])) | (addr_overdie & addr_reg_overdie[11])), (((not_busy & addr[10]) | (stage3_wire & quad_addr_reg[6])) | (addr_overdie & addr_reg_overdie[10])), (((not_busy & addr[9]) | (stage3_wire & quad_addr_reg[5])) | (addr_overdie & addr_reg_overdie[9])), (((not_busy & addr[8]) | (stage3_wire & quad_addr_reg[4])) | (addr_overdie & addr_reg_overdie[8])), (((not_busy & addr[7]) | (stage3_wire & quad_addr_reg[3])) | (addr_overdie & addr_reg_overdie[7])), (((not_busy & addr[6]) | (stage3_wire & quad_addr_reg[2])) | (addr_overdie & addr_reg_overdie[6])), (((not_busy & addr[5]) | (stage3_wire & quad_addr_reg[1])) | (addr_overdie & addr_reg_overdie[5])), (((not_busy & addr[4]) | (stage3_wire & quad_addr_reg[0])) | (addr_overdie & addr_reg_overdie[4])), ((({2{not_busy}} & addr[3:2]) | {2{stage3_wire}}) | ({2{addr_overdie}} & addr_reg_overdie[3:2])), (({2{not_busy}} & addr[1:0]) | ({2{addr_overdie}} & addr_reg_overdie[1:0]))};
	...
	assign		wire_mux2113_dataout = (do_write === 1'b1) ? (((~ wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) : ((wire_gen_cntr_q[2] & (~ wire_gen_cntr_q[1])) & wire_gen_cntr_q[0]);
	...
	assign		wire_mux216a_dataout = (do_fast_read === 1'b1) ? {read_dout_quad_reg[7:0]} : {read_dout_reg[7:0]};
	assign		wire_mux217_dataout = (do_fast_read === 1'b1) ? dvalid_reg : dvalid_reg2;
	assign		wire_mux218_dataout = (do_fast_read === 1'b1) ? (((((do_fast_read & end_fast_read) & (~ wire_gen_cntr_q[2])) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) | clr_read_wire2) : (((((do_read | do_fast_read) & (~ wire_gen_cntr_q[2])) & wire_gen_cntr_q[1]) & wire_gen_cntr_q[0]) | clr_read_wire2);
	assign		wire_mux219_dataout = (do_fast_read === 1'b1) ? (((~ wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) : ((wire_gen_cntr_q[2] & (~ wire_gen_cntr_q[1])) & wire_gen_cntr_q[0]);
	scfifo   scfifo10
	( 
	.aclr(reset),
	.almost_empty(),
	...
	defparam
		scfifo10.lpm_numwords = 258,
		scfifo10.lpm_width = 8,
		scfifo10.lpm_widthu = 9,
		scfifo10.use_eab = "ON",
		scfifo10.lpm_type = "scfifo";
	stratixv_asmiblock   sd4
	( 
	...
	defparam
		...
		sd4.lpm_type = "stratixv_asmiblock";
	assign
		addr_overdie = 1'b0,
		...
		clr_endrbyte_wire = wire_mux218_dataout,
		...
		data_valid_wire = wire_mux217_dataout,
		...
		end_add_cycle_mux_datab_wire = ((wire_addbyte_cntr_q[3] & wire_addbyte_cntr_q[2]) & wire_addbyte_cntr_q[0]),
		...
		read_data_reg_in_wire = {wire_mux216a_dataout[7:0]},
		read_opcode = {8{1'b0}},
