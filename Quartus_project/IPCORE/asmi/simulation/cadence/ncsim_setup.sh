...
TOP_LEVEL_NAME="asmi"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/teko/altera_std/16.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/asmi_parallel_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/asmi_asmi_parallel_0.v" -work asmi_parallel_0 -cdslib ./cds_libs/asmi_parallel_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/asmi.v"                                                                                            
fi
