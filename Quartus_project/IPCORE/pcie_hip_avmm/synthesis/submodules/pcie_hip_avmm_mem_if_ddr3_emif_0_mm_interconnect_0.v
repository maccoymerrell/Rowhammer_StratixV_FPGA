// pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0 (
		...
		input  wire        seq_bridge_reset_reset_bridge_in_reset_reset,                //                seq_bridge_reset_reset_bridge_in_reset.reset
	...
	wire          rsp_mux_001_src_valid;                                             // rsp_mux_001:src_valid -> seq_bridge_m0_agent:rp_valid
	wire  [101:0] rsp_mux_001_src_data;                                              // rsp_mux_001:src_data -> seq_bridge_m0_agent:rp_data
	wire          rsp_mux_001_src_ready;                                             // seq_bridge_m0_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                           // rsp_mux_001:src_channel -> seq_bridge_m0_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                     // rsp_mux_001:src_startofpacket -> seq_bridge_m0_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                       // rsp_mux_001:src_endofpacket -> seq_bridge_m0_agent:rp_endofpacket
	...
	wire  [101:0] seq_bridge_m0_agent_cp_data;                                       // seq_bridge_m0_agent:cp_data -> router_001:sink_data
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_router router (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_router router_001 (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_router_002 router_002 (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset              (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset               (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
