...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_ddr3_m2_s0 (
		...
		output wire [63:0]  afi_addr,                     //              afi.afi_addr
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("pcie_hip_avmm_ddr3_m2_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("pcie_hip_avmm_ddr3_m2_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (33792),
		.INIT_FILE        ("pcie_hip_avmm_ddr3_m2_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	pcie_hip_avmm_ddr3_m2_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	pcie_hip_avmm_ddr3_m2_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
