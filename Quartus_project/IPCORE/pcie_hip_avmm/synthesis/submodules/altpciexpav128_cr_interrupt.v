...
// 
module altpciexpav128_cr_interrupt
...
#(
  ...
  // wire            SelAvlIrq_sig ;
   ...
   wire [5:0]      PciComp_Stat_Reg_sync ;
  ...
  endgenerate
   ...
   altpciexpav128_clksync datadiscard_sync
     (
   ...
   altpciexpav128_clksync writefail_sync
     (
      .cg_common_clock_mode_i(cg_common_clock_mode_i), 
      .Clk1_i(PciClk_i), 
      .Clk2_i(CraClk_i), 
   ...
   altpciexpav128_clksync readfail_sync
     (
      .cg_common_clock_mode_i(cg_common_clock_mode_i), 
      .Clk1_i(PciClk_i), 
      .Clk2_i(CraClk_i), 
   ...
   assign PciComp_Stat_Reg_sync = cg_common_clock_mode_i ? 
          PciComp_Stat_Reg_i : PciComp_Stat_Reg_q2 ;
...
endgenerate
   ...
   always @(posedge CraClk_i or negedge CraRstn_i)
     begin
        if (CraRstn_i == 1'b0)
          begin
             AvlRuptEnable_reg <= 32'h00000000 ;
          end
        else
          begin
             if ( (IcrAddress_i == 
