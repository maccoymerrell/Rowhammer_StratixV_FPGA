...
lappend arg_list "--component-param=DELAY_PER_OPA_TAP=208"
...
lappend arg_list "--component-param=AFI_ADDRESS_WIDTH=52"
...
lappend arg_list "--component-param=AFI_CHIP_SELECT_WIDTH=8"
...
lappend arg_list "--component-param=MEM_TINIT_CK=300000"
lappend arg_list "--component-param=MEM_TMRD_CK=4"
lappend arg_list "--component-param=AFI_DEBUG_INFO_WIDTH=32"
lappend arg_list "--component-param=AFI_CLK_EN_WIDTH=8"
lappend arg_list "--component-param=AFI_ODT_WIDTH=8"
...
lappend arg_list "--component-param=MR1_RTT=1"
...
lappend arg_list "--component-param=USE_SHADOW_REGS=true"
...
lappend arg_list "--component-param=SEQ_ROM=pcie_hip_avmm_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=pcie_hip_avmm_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=pcie_hip_avmm_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=33792"
...
lappend arg_list "--component-param=AVL_CLK_PS=13333"
...
lappend arg_list "--output-name=pcie_hip_avmm_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXV"
lappend arg_list "--report-file=sopcinfo:pcie_hip_avmm_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:pcie_hip_avmm_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/home/grads/t/teko/altera_std/16.0/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
