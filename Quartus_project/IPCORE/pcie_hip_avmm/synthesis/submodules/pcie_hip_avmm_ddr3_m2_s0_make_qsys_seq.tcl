...
lappend arg_list "--component-param=AFI_ADDRESS_WIDTH=64"
...
lappend arg_list "--component-param=MEM_ADDRESS_WIDTH=16"
...
lappend arg_list "--component-param=SEQ_ROM=pcie_hip_avmm_ddr3_m2_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=pcie_hip_avmm_ddr3_m2_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=pcie_hip_avmm_ddr3_m2_s0_inst_ROM.hex"
...
lappend arg_list "--output-name=pcie_hip_avmm_ddr3_m2_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXV"
lappend arg_list "--report-file=sopcinfo:pcie_hip_avmm_ddr3_m2_s0.sopcinfo"
lappend arg_list "--report-file=txt:pcie_hip_avmm_ddr3_m2_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/home/teko/altera_std/16.0/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
