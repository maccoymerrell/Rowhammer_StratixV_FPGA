// pcie_hip_avmm_ddr3_m2_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_ddr3_m2_mm_interconnect_0 (
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_router router (
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_router router_001 (
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_router_002 router_002 (
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset              (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_ddr3_m2_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset               (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
