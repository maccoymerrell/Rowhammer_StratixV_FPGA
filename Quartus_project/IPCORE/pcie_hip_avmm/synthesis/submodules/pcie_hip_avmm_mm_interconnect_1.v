// pcie_hip_avmm_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_mm_interconnect_1 (
		...
		input  wire [5:0]   DUT_Rxm_BAR2_burstcount,                                             //                                                              .burstcount
		input  wire [15:0]  DUT_Rxm_BAR2_byteenable,                                             //                                                              .byteenable
		input  wire         DUT_Rxm_BAR2_read,                                                   //                                                              .read
		output wire [127:0] DUT_Rxm_BAR2_readdata,                                               //                                                              .readdata
		output wire         DUT_Rxm_BAR2_readdatavalid,                                          //                                                              .readdatavalid
		input  wire         DUT_Rxm_BAR2_write,                                                  //                                                              .write
		input  wire [127:0] DUT_Rxm_BAR2_writedata,                                              //                                                              .writedata
		input  wire [31:0]  move_engine_0_fast_master_address,                                   //                                     move_engine_0_fast_master.address
		output wire         move_engine_0_fast_master_waitrequest,                               //                                                              .waitrequest
		input  wire [5:0]   move_engine_0_fast_master_burstcount,                                //                                                              .burstcount
		input  wire         move_engine_0_fast_master_read,                                      //                                                              .read
		output wire [511:0] move_engine_0_fast_master_readdata,                                  //                                                              .readdata
		output wire         move_engine_0_fast_master_readdatavalid,                             //                                                              .readdatavalid
		input  wire         move_engine_0_fast_master_write,                                     //                                                              .write
		input  wire [511:0] move_engine_0_fast_master_writedata,                                 //                                                              .writedata
		input  wire         move_engine_0_fast_master_lock,                                      //                                                              .lock
	...
	wire  [127:0] dut_rxm_bar2_translator_avalon_universal_master_0_readdata;                   // DUT_Rxm_BAR2_agent:av_readdata -> DUT_Rxm_BAR2_translator:uav_readdata
	...
	wire   [15:0] dut_rxm_bar2_translator_avalon_universal_master_0_byteenable;                 // DUT_Rxm_BAR2_translator:uav_byteenable -> DUT_Rxm_BAR2_agent:av_byteenable
	...
	wire  [127:0] dut_rxm_bar2_translator_avalon_universal_master_0_writedata;                  // DUT_Rxm_BAR2_translator:uav_writedata -> DUT_Rxm_BAR2_agent:av_writedata
	wire    [9:0] dut_rxm_bar2_translator_avalon_universal_master_0_burstcount;                 // DUT_Rxm_BAR2_translator:uav_burstcount -> DUT_Rxm_BAR2_agent:av_burstcount
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_waitrequest;   // move_engine_0_fast_master_agent:av_waitrequest -> move_engine_0_fast_master_translator:uav_waitrequest
	wire  [511:0] move_engine_0_fast_master_translator_avalon_universal_master_0_readdata;      // move_engine_0_fast_master_agent:av_readdata -> move_engine_0_fast_master_translator:uav_readdata
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_debugaccess;   // move_engine_0_fast_master_translator:uav_debugaccess -> move_engine_0_fast_master_agent:av_debugaccess
	wire   [63:0] move_engine_0_fast_master_translator_avalon_universal_master_0_address;       // move_engine_0_fast_master_translator:uav_address -> move_engine_0_fast_master_agent:av_address
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_read;          // move_engine_0_fast_master_translator:uav_read -> move_engine_0_fast_master_agent:av_read
	wire   [63:0] move_engine_0_fast_master_translator_avalon_universal_master_0_byteenable;    // move_engine_0_fast_master_translator:uav_byteenable -> move_engine_0_fast_master_agent:av_byteenable
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_readdatavalid; // move_engine_0_fast_master_agent:av_readdatavalid -> move_engine_0_fast_master_translator:uav_readdatavalid
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_lock;          // move_engine_0_fast_master_translator:uav_lock -> move_engine_0_fast_master_agent:av_lock
	wire          move_engine_0_fast_master_translator_avalon_universal_master_0_write;         // move_engine_0_fast_master_translator:uav_write -> move_engine_0_fast_master_agent:av_write
	wire  [511:0] move_engine_0_fast_master_translator_avalon_universal_master_0_writedata;     // move_engine_0_fast_master_translator:uav_writedata -> move_engine_0_fast_master_agent:av_writedata
	wire   [11:0] move_engine_0_fast_master_translator_avalon_universal_master_0_burstcount;    // move_engine_0_fast_master_translator:uav_burstcount -> move_engine_0_fast_master_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                        // rsp_mux_001:src_valid -> move_engine_0_fast_master_agent:rp_valid
	wire  [682:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> move_engine_0_fast_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                        // move_engine_0_fast_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                      // rsp_mux_001:src_channel -> move_engine_0_fast_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                // rsp_mux_001:src_startofpacket -> move_engine_0_fast_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                  // rsp_mux_001:src_endofpacket -> move_engine_0_fast_master_agent:rp_endofpacket
	...
	wire   [63:0] mem_if_ddr3_emif_0_avl_agent_m0_address;                                      // mem_if_ddr3_emif_0_avl_agent:m0_address -> mem_if_ddr3_emif_0_avl_translator:uav_address
	...
	wire  [683:0] mem_if_ddr3_emif_0_avl_agent_rf_source_data;                                  // mem_if_ddr3_emif_0_avl_agent:rf_source_data -> mem_if_ddr3_emif_0_avl_agent_rsp_fifo:in_data
	...
	wire  [683:0] mem_if_ddr3_emif_0_avl_agent_rsp_fifo_out_data;                               // mem_if_ddr3_emif_0_avl_agent_rsp_fifo:out_data -> mem_if_ddr3_emif_0_avl_agent:rf_sink_data
	...
	wire          dut_rxm_bar2_agent_cp_valid;                                                  // DUT_Rxm_BAR2_agent:cp_valid -> router:sink_valid
	wire  [250:0] dut_rxm_bar2_agent_cp_data;                                                   // DUT_Rxm_BAR2_agent:cp_data -> router:sink_data
	wire          dut_rxm_bar2_agent_cp_ready;                                                  // router:sink_ready -> DUT_Rxm_BAR2_agent:cp_ready
	wire          dut_rxm_bar2_agent_cp_startofpacket;                                          // DUT_Rxm_BAR2_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dut_rxm_bar2_agent_cp_endofpacket;                                            // DUT_Rxm_BAR2_agent:cp_endofpacket -> router:sink_endofpacket
	wire          move_engine_0_fast_master_agent_cp_valid;                                     // move_engine_0_fast_master_agent:cp_valid -> router_001:sink_valid
	wire  [682:0] move_engine_0_fast_master_agent_cp_data;                                      // move_engine_0_fast_master_agent:cp_data -> router_001:sink_data
	wire          move_engine_0_fast_master_agent_cp_ready;                                     // router_001:sink_ready -> move_engine_0_fast_master_agent:cp_ready
	wire          move_engine_0_fast_master_agent_cp_startofpacket;                             // move_engine_0_fast_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          move_engine_0_fast_master_agent_cp_endofpacket;                               // move_engine_0_fast_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [682:0] mem_if_ddr3_emif_0_avl_agent_rp_data;                                         // mem_if_ddr3_emif_0_avl_agent:rp_data -> router_002:sink_data
	...
	wire          cmd_mux_src_valid;                                                            // cmd_mux:src_valid -> mem_if_ddr3_emif_0_avl_burst_adapter:sink0_valid
	wire  [682:0] cmd_mux_src_data;                                                             // cmd_mux:src_data -> mem_if_ddr3_emif_0_avl_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                            // mem_if_ddr3_emif_0_avl_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                          // cmd_mux:src_channel -> mem_if_ddr3_emif_0_avl_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                                    // cmd_mux:src_startofpacket -> mem_if_ddr3_emif_0_avl_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                                      // cmd_mux:src_endofpacket -> mem_if_ddr3_emif_0_avl_burst_adapter:sink0_endofpacket
	...
	wire  [682:0] mem_if_ddr3_emif_0_avl_burst_adapter_source0_data;                            // mem_if_ddr3_emif_0_avl_burst_adapter:source0_data -> mem_if_ddr3_emif_0_avl_agent:cp_data
	...
	wire          rsp_mux_src_valid;                                                            // rsp_mux:src_valid -> DUT_Rxm_BAR2_rsp_width_adapter:in_valid
	wire  [682:0] rsp_mux_src_data;                                                             // rsp_mux:src_data -> DUT_Rxm_BAR2_rsp_width_adapter:in_data
	wire          rsp_mux_src_ready;                                                            // DUT_Rxm_BAR2_rsp_width_adapter:in_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                          // rsp_mux:src_channel -> DUT_Rxm_BAR2_rsp_width_adapter:in_channel
	wire          rsp_mux_src_startofpacket;                                                    // rsp_mux:src_startofpacket -> DUT_Rxm_BAR2_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_src_endofpacket;                                                      // rsp_mux:src_endofpacket -> DUT_Rxm_BAR2_rsp_width_adapter:in_endofpacket
	wire          dut_rxm_bar2_rsp_width_adapter_src_valid;                                     // DUT_Rxm_BAR2_rsp_width_adapter:out_valid -> DUT_Rxm_BAR2_agent:rp_valid
	wire  [250:0] dut_rxm_bar2_rsp_width_adapter_src_data;                                      // DUT_Rxm_BAR2_rsp_width_adapter:out_data -> DUT_Rxm_BAR2_agent:rp_data
	wire          dut_rxm_bar2_rsp_width_adapter_src_ready;                                     // DUT_Rxm_BAR2_agent:rp_ready -> DUT_Rxm_BAR2_rsp_width_adapter:out_ready
	wire    [1:0] dut_rxm_bar2_rsp_width_adapter_src_channel;                                   // DUT_Rxm_BAR2_rsp_width_adapter:out_channel -> DUT_Rxm_BAR2_agent:rp_channel
	wire          dut_rxm_bar2_rsp_width_adapter_src_startofpacket;                             // DUT_Rxm_BAR2_rsp_width_adapter:out_startofpacket -> DUT_Rxm_BAR2_agent:rp_startofpacket
	wire          dut_rxm_bar2_rsp_width_adapter_src_endofpacket;                               // DUT_Rxm_BAR2_rsp_width_adapter:out_endofpacket -> DUT_Rxm_BAR2_agent:rp_endofpacket
	wire          router_src_valid;                                                             // router:src_valid -> DUT_Rxm_BAR2_cmd_width_adapter:in_valid
	wire  [250:0] router_src_data;                                                              // router:src_data -> DUT_Rxm_BAR2_cmd_width_adapter:in_data
	wire          router_src_ready;                                                             // DUT_Rxm_BAR2_cmd_width_adapter:in_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                           // router:src_channel -> DUT_Rxm_BAR2_cmd_width_adapter:in_channel
	wire          router_src_startofpacket;                                                     // router:src_startofpacket -> DUT_Rxm_BAR2_cmd_width_adapter:in_startofpacket
	wire          router_src_endofpacket;                                                       // router:src_endofpacket -> DUT_Rxm_BAR2_cmd_width_adapter:in_endofpacket
	wire          dut_rxm_bar2_cmd_width_adapter_src_valid;                                     // DUT_Rxm_BAR2_cmd_width_adapter:out_valid -> cmd_demux:sink_valid
	wire  [682:0] dut_rxm_bar2_cmd_width_adapter_src_data;                                      // DUT_Rxm_BAR2_cmd_width_adapter:out_data -> cmd_demux:sink_data
	wire          dut_rxm_bar2_cmd_width_adapter_src_ready;                                     // cmd_demux:sink_ready -> DUT_Rxm_BAR2_cmd_width_adapter:out_ready
	wire    [1:0] dut_rxm_bar2_cmd_width_adapter_src_channel;                                   // DUT_Rxm_BAR2_cmd_width_adapter:out_channel -> cmd_demux:sink_channel
	wire          dut_rxm_bar2_cmd_width_adapter_src_startofpacket;                             // DUT_Rxm_BAR2_cmd_width_adapter:out_startofpacket -> cmd_demux:sink_startofpacket
	wire          dut_rxm_bar2_cmd_width_adapter_src_endofpacket;                               // DUT_Rxm_BAR2_cmd_width_adapter:out_endofpacket -> cmd_demux:sink_endofpacket
	...
	altera_merlin_master_translator #(
		...
		.uav_address            (dut_rxm_bar2_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dut_rxm_bar2_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dut_rxm_bar2_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dut_rxm_bar2_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dut_rxm_bar2_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dut_rxm_bar2_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dut_rxm_bar2_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dut_rxm_bar2_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dut_rxm_bar2_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dut_rxm_bar2_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dut_rxm_bar2_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (DUT_Rxm_BAR2_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (DUT_Rxm_BAR2_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (DUT_Rxm_BAR2_burstcount),                                         //                          .burstcount
		.av_byteenable          (DUT_Rxm_BAR2_byteenable),                                         //                          .byteenable
		.av_read                (DUT_Rxm_BAR2_read),                                               //                          .read
		.av_readdata            (DUT_Rxm_BAR2_readdata),                                           //                          .readdata
		.av_readdatavalid       (DUT_Rxm_BAR2_readdatavalid),                                      //                          .readdatavalid
		.av_write               (DUT_Rxm_BAR2_write),                                              //                          .write
		.av_writedata           (DUT_Rxm_BAR2_writedata),                                          //                          .writedata
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) move_engine_0_fast_master_translator (
		.clk                    (DUT_coreclkout_clk),                                                           //                       clk.clk
		.reset                  (move_engine_0_rst_reset_bridge_in_reset_reset),                                //                     reset.reset
		.uav_address            (move_engine_0_fast_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (move_engine_0_fast_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (move_engine_0_fast_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (move_engine_0_fast_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (move_engine_0_fast_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (move_engine_0_fast_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (move_engine_0_fast_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (move_engine_0_fast_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (move_engine_0_fast_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (move_engine_0_fast_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (move_engine_0_fast_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (move_engine_0_fast_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (move_engine_0_fast_master_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (move_engine_0_fast_master_burstcount),                                         //                          .burstcount
		.av_read                (move_engine_0_fast_master_read),                                               //                          .read
		.av_readdata            (move_engine_0_fast_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (move_engine_0_fast_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (move_engine_0_fast_master_write),                                              //                          .write
		.av_writedata           (move_engine_0_fast_master_writedata),                                          //                          .writedata
		.av_lock                (move_engine_0_fast_master_lock),                                               //                          .lock
	...
	altera_merlin_master_agent #(
		...
		.av_address            (dut_rxm_bar2_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dut_rxm_bar2_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dut_rxm_bar2_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dut_rxm_bar2_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dut_rxm_bar2_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dut_rxm_bar2_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dut_rxm_bar2_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dut_rxm_bar2_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dut_rxm_bar2_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dut_rxm_bar2_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dut_rxm_bar2_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dut_rxm_bar2_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dut_rxm_bar2_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dut_rxm_bar2_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dut_rxm_bar2_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dut_rxm_bar2_agent_cp_ready),                                     //          .ready
		.rp_valid              (dut_rxm_bar2_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (dut_rxm_bar2_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (dut_rxm_bar2_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (dut_rxm_bar2_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (dut_rxm_bar2_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (dut_rxm_bar2_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                // (terminated)
		.av_writeresponsevalid ()                                                                 // (terminated)
	);
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) move_engine_0_fast_master_agent (
		.clk                   (DUT_coreclkout_clk),                                                           //       clk.clk
		.reset                 (move_engine_0_rst_reset_bridge_in_reset_reset),                                // clk_reset.reset
		.av_address            (move_engine_0_fast_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (move_engine_0_fast_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (move_engine_0_fast_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (move_engine_0_fast_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (move_engine_0_fast_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (move_engine_0_fast_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (move_engine_0_fast_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (move_engine_0_fast_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (move_engine_0_fast_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (move_engine_0_fast_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (move_engine_0_fast_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (move_engine_0_fast_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (move_engine_0_fast_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (move_engine_0_fast_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (move_engine_0_fast_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (move_engine_0_fast_master_agent_cp_ready),                                     //          .ready
	...
	pcie_hip_avmm_mm_interconnect_1_router router (
		.sink_ready         (dut_rxm_bar2_agent_cp_ready),                   //      sink.ready
		.sink_valid         (dut_rxm_bar2_agent_cp_valid),                   //          .valid
		.sink_data          (dut_rxm_bar2_agent_cp_data),                    //          .data
		.sink_startofpacket (dut_rxm_bar2_agent_cp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (dut_rxm_bar2_agent_cp_endofpacket),             //          .endofpacket
		.clk                (DUT_coreclkout_clk),                            //       clk.clk
		.reset              (move_engine_0_rst_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mm_interconnect_1_router_001 router_001 (
		.sink_ready         (move_engine_0_fast_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (move_engine_0_fast_master_agent_cp_valid),         //          .valid
		.sink_data          (move_engine_0_fast_master_agent_cp_data),          //          .data
		.sink_startofpacket (move_engine_0_fast_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (move_engine_0_fast_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (DUT_coreclkout_clk),                               //       clk.clk
		.reset              (move_engine_0_rst_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	pcie_hip_avmm_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (DUT_coreclkout_clk),                               //       clk.clk
		.reset              (move_engine_0_rst_reset_bridge_in_reset_reset),    // clk_reset.reset
		.sink_ready         (dut_rxm_bar2_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (dut_rxm_bar2_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (dut_rxm_bar2_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (dut_rxm_bar2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (dut_rxm_bar2_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (dut_rxm_bar2_cmd_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) dut_rxm_bar2_rsp_width_adapter (
		.clk                  (DUT_coreclkout_clk),                               //       clk.clk
		.reset                (move_engine_0_rst_reset_bridge_in_reset_reset),    // clk_reset.reset
		...
		.out_endofpacket      (dut_rxm_bar2_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dut_rxm_bar2_rsp_width_adapter_src_data),          //          .data
		.out_channel          (dut_rxm_bar2_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (dut_rxm_bar2_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (dut_rxm_bar2_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dut_rxm_bar2_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) dut_rxm_bar2_cmd_width_adapter (
		.clk                  (DUT_coreclkout_clk),                               //       clk.clk
		.reset                (move_engine_0_rst_reset_bridge_in_reset_reset),    // clk_reset.reset
		...
		.out_endofpacket      (dut_rxm_bar2_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (dut_rxm_bar2_cmd_width_adapter_src_data),          //          .data
		.out_channel          (dut_rxm_bar2_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (dut_rxm_bar2_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (dut_rxm_bar2_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (dut_rxm_bar2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                            // (terminated)
	);
