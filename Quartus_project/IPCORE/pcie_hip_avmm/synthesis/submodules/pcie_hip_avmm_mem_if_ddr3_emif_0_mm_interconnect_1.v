// pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1 (
	...
	wire  [17:0] csr_bridge_m0_translator_avalon_universal_master_0_address;       // csr_bridge_m0_translator:uav_address -> csr_bridge_m0_agent:av_address
	...
	wire  [17:0] p0_csr_agent_m0_address;                                          // p0_csr_agent:m0_address -> p0_csr_translator:uav_address
	...
	wire  [88:0] p0_csr_agent_rf_source_data;                                      // p0_csr_agent:rf_source_data -> p0_csr_agent_rsp_fifo:in_data
	...
	wire  [88:0] p0_csr_agent_rsp_fifo_out_data;                                   // p0_csr_agent_rsp_fifo:out_data -> p0_csr_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                 // cmd_mux:src_data -> p0_csr_agent:cp_data
	...
	wire  [17:0] c0_csr_agent_m0_address;                                          // c0_csr_agent:m0_address -> c0_csr_translator:uav_address
	...
	wire  [88:0] c0_csr_agent_rf_source_data;                                      // c0_csr_agent:rf_source_data -> c0_csr_agent_rsp_fifo:in_data
	...
	wire  [88:0] c0_csr_agent_rsp_fifo_out_data;                                   // c0_csr_agent_rsp_fifo:out_data -> c0_csr_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                             // cmd_mux_001:src_data -> c0_csr_agent:cp_data
	...
	wire  [87:0] csr_bridge_m0_agent_cp_data;                                      // csr_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [87:0] p0_csr_agent_rp_data;                                             // p0_csr_agent:rp_data -> router_001:sink_data
	...
	wire  [87:0] c0_csr_agent_rp_data;                                             // c0_csr_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] router_src_data;                                                  // router:src_data -> csr_bridge_m0_limiter:cmd_sink_data
	...
	wire  [87:0] csr_bridge_m0_limiter_cmd_src_data;                               // csr_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [87:0] rsp_mux_src_data;                                                 // rsp_mux:src_data -> csr_bridge_m0_limiter:rsp_sink_data
	...
	wire  [87:0] csr_bridge_m0_limiter_rsp_src_data;                               // csr_bridge_m0_limiter:rsp_src_data -> csr_bridge_m0_agent:rp_data
	...
	wire  [87:0] cmd_demux_src0_data;                                              // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [87:0] crosser_out_data;                                                 // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [87:0] cmd_demux_src1_data;                                              // cmd_demux:src1_data -> crosser_001:in_data
	...
	wire  [87:0] crosser_001_out_data;                                             // crosser_001:out_data -> cmd_mux_001:sink0_data
	...
	wire  [87:0] rsp_demux_src0_data;                                              // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [87:0] crosser_002_out_data;                                             // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [87:0] rsp_demux_001_src0_data;                                          // rsp_demux_001:src0_data -> crosser_003:in_data
	...
	wire  [87:0] crosser_003_out_data;                                             // crosser_003:out_data -> rsp_mux:sink1_data
	...
	altera_merlin_master_agent #(
		...
		.cp_valid              (csr_bridge_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (csr_bridge_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (csr_bridge_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (csr_bridge_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (csr_bridge_m0_agent_cp_ready),                                     //          .ready
		.rp_valid              (csr_bridge_m0_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (csr_bridge_m0_limiter_rsp_src_data),                               //          .data
		.rp_channel            (csr_bridge_m0_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (csr_bridge_m0_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (csr_bridge_m0_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (csr_bridge_m0_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                 // (terminated)
		.av_writeresponsevalid ()                                                                  // (terminated)
	);
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_router router (
		.sink_ready         (csr_bridge_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (csr_bridge_m0_agent_cp_valid),                 //          .valid
		.sink_data          (csr_bridge_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (csr_bridge_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (csr_bridge_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset              (csr_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_router_001 router_001 (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_router_001 router_002 (
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (csr_bridge_m0_limiter_cmd_src_ready),          //   cmd_src.ready
		.cmd_src_data           (csr_bridge_m0_limiter_cmd_src_data),           //          .data
		.cmd_src_channel        (csr_bridge_m0_limiter_cmd_src_channel),        //          .channel
		.cmd_src_startofpacket  (csr_bridge_m0_limiter_cmd_src_startofpacket),  //          .startofpacket
		.cmd_src_endofpacket    (csr_bridge_m0_limiter_cmd_src_endofpacket),    //          .endofpacket
		...
		.rsp_src_ready          (csr_bridge_m0_limiter_rsp_src_ready),          //   rsp_src.ready
		.rsp_src_valid          (csr_bridge_m0_limiter_rsp_src_valid),          //          .valid
		.rsp_src_data           (csr_bridge_m0_limiter_rsp_src_data),           //          .data
		.rsp_src_channel        (csr_bridge_m0_limiter_rsp_src_channel),        //          .channel
		.rsp_src_startofpacket  (csr_bridge_m0_limiter_rsp_src_startofpacket),  //          .startofpacket
		.rsp_src_endofpacket    (csr_bridge_m0_limiter_rsp_src_endofpacket),    //          .endofpacket
		.cmd_src_valid          (csr_bridge_m0_limiter_cmd_valid_data)          // cmd_valid.data
	);

	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (afi_clk_out_clk_1_clk),                        //        clk.clk
		.reset              (csr_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (csr_bridge_m0_limiter_cmd_src_ready),          //       sink.ready
		.sink_channel       (csr_bridge_m0_limiter_cmd_src_channel),        //           .channel
		.sink_data          (csr_bridge_m0_limiter_cmd_src_data),           //           .data
		.sink_startofpacket (csr_bridge_m0_limiter_cmd_src_startofpacket),  //           .startofpacket
		.sink_endofpacket   (csr_bridge_m0_limiter_cmd_src_endofpacket),    //           .endofpacket
		.sink_valid         (csr_bridge_m0_limiter_cmd_valid_data),         // sink_valid.data
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll0_afi_clk_clk),                                    //       clk.clk
		.reset               (p0_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (pll0_afi_clk_clk),                                    //       clk.clk
		.reset               (p0_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pll0_afi_clk_clk),                                    //       clk.clk
		.reset              (p0_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (pll0_afi_clk_clk),                                    //       clk.clk
		.reset              (p0_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (afi_clk_out_clk_1_clk),                        //       clk.clk
		.reset               (csr_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (csr_bridge_reset_reset_bridge_in_reset_reset),        //  in_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (csr_bridge_reset_reset_bridge_in_reset_reset),        // out_clk_reset.reset
