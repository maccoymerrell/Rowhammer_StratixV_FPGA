// pcie_hip_avmm_mem_if_ddr3_emif_0_s0.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_mem_if_ddr3_emif_0_s0 (
		...
		output wire [51:0]  afi_addr,                     //              afi.afi_addr
		output wire [11:0]  afi_ba,                       //                 .afi_ba
		output wire [7:0]   afi_cs_n,                     //                 .afi_cs_n
		output wire [7:0]   afi_cke,                      //                 .afi_cke
		output wire [7:0]   afi_odt,                      //                 .afi_odt
		...
		output wire [63:0]  afi_rrank,                    //                 .afi_rrank
		output wire [63:0]  afi_wrank,                    //                 .afi_wrank
		...
		output wire [7:0]   scc_upd,                      //                 .scc_upd
		output wire [7:0]   scc_sr_dqsenable_delayctrl,   //                 .scc_sr_dqsenable_delayctrl
		output wire [7:0]   scc_sr_dqsdisablen_delayctrl, //                 .scc_sr_dqsdisablen_delayctrl
		output wire [7:0]   scc_sr_multirank_delayctrl,   //                 .scc_sr_multirank_delayctrl
	...
	wire  [13:0] mm_interconnect_0_sequencer_mem_s1_address;                // mm_interconnect_0:sequencer_mem_s1_address -> sequencer_mem:s1_address
	...
	sequencer_scc_mgr #(
		...
		.scc_sr_dqsenable_delayctrl   (scc_sr_dqsenable_delayctrl),                               //                 .scc_sr_dqsenable_delayctrl
		.scc_sr_dqsdisablen_delayctrl (scc_sr_dqsdisablen_delayctrl),                             //                 .scc_sr_dqsdisablen_delayctrl
		.scc_sr_multirank_delayctrl   (scc_sr_multirank_delayctrl),                               //                 .scc_sr_multirank_delayctrl
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("pcie_hip_avmm_mem_if_ddr3_emif_0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("pcie_hip_avmm_mem_if_ddr3_emif_0_s0_inst_ROM.hex"),
		...
		.afi_rrank         (afi_rrank),                                               //          .afi_rrank
		.afi_wrank         (afi_wrank),                                               //          .afi_wrank
		.csr_clk           (),                                                        //       csr.csr_clk
		.csr_ena           (),                                                        //          .csr_ena
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (33792),
		.INIT_FILE        ("pcie_hip_avmm_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	pcie_hip_avmm_mem_if_ddr3_emif_0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
