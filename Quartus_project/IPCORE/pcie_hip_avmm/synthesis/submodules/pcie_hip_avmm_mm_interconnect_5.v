// pcie_hip_avmm_mm_interconnect_5.v
...
`timescale 1 ps / 1 ps
module pcie_hip_avmm_mm_interconnect_5 (
	...
	wire   [29:0] mm_bridge_0_m0_translator_avalon_universal_master_0_address;       // mm_bridge_0_m0_translator:uav_address -> mm_bridge_0_m0_agent:av_address
	...
	wire  [213:0] rsp_mux_src_data;                                                  // rsp_mux:src_data -> mm_bridge_0_m0_agent:rp_data
	...
	wire  [646:0] mem_if_ddr3_emif_0_avl_agent_rf_source_data;                       // mem_if_ddr3_emif_0_avl_agent:rf_source_data -> mem_if_ddr3_emif_0_avl_agent_rsp_fifo:in_data
	...
	wire  [646:0] mem_if_ddr3_emif_0_avl_agent_rsp_fifo_out_data;                    // mem_if_ddr3_emif_0_avl_agent_rsp_fifo:out_data -> mem_if_ddr3_emif_0_avl_agent:rf_sink_data
	...
	wire  [213:0] mm_bridge_0_m0_agent_cp_data;                                      // mm_bridge_0_m0_agent:cp_data -> router:sink_data
	...
	wire  [645:0] mem_if_ddr3_emif_0_avl_agent_rp_data;                              // mem_if_ddr3_emif_0_avl_agent:rp_data -> router_001:sink_data
	...
	wire  [213:0] cmd_mux_src_data;                                                  // cmd_mux:src_data -> mem_if_ddr3_emif_0_avl_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                 // mem_if_ddr3_emif_0_avl_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                               // cmd_mux:src_channel -> mem_if_ddr3_emif_0_avl_cmd_width_adapter:in_channel
	...
	wire  [645:0] mem_if_ddr3_emif_0_avl_cmd_width_adapter_src_data;                 // mem_if_ddr3_emif_0_avl_cmd_width_adapter:out_data -> mem_if_ddr3_emif_0_avl_agent:cp_data
	...
	wire    [0:0] mem_if_ddr3_emif_0_avl_cmd_width_adapter_src_channel;              // mem_if_ddr3_emif_0_avl_cmd_width_adapter:out_channel -> mem_if_ddr3_emif_0_avl_agent:cp_channel
	...
	wire  [645:0] router_001_src_data;                                               // router_001:src_data -> mem_if_ddr3_emif_0_avl_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                              // mem_if_ddr3_emif_0_avl_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                            // router_001:src_channel -> mem_if_ddr3_emif_0_avl_rsp_width_adapter:in_channel
	...
	wire  [213:0] mem_if_ddr3_emif_0_avl_rsp_width_adapter_src_data;                 // mem_if_ddr3_emif_0_avl_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire    [0:0] mem_if_ddr3_emif_0_avl_rsp_width_adapter_src_channel;              // mem_if_ddr3_emif_0_avl_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire  [213:0] cmd_demux_src0_data;                                               // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [213:0] crosser_out_data;                                                  // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [213:0] rsp_demux_src0_data;                                               // rsp_demux:src0_data -> crosser_001:in_data
	...
	wire  [213:0] crosser_001_out_data;                                              // crosser_001:out_data -> rsp_mux:sink0_data
	...
	pcie_hip_avmm_mm_interconnect_5_router router (
	...
	pcie_hip_avmm_mm_interconnect_5_router_001 router_001 (
	...
	pcie_hip_avmm_mm_interconnect_5_cmd_demux cmd_demux (
		.clk                (DUT_coreclkout_clk),                            //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mm_interconnect_5_cmd_mux cmd_mux (
		.clk                 (mem_if_ddr3_emif_0_afi_clk_clk),                                      //       clk.clk
		.reset               (mem_if_ddr3_emif_0_avl_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mm_interconnect_5_rsp_demux rsp_demux (
		.clk                (mem_if_ddr3_emif_0_afi_clk_clk),                                      //       clk.clk
		.reset              (mem_if_ddr3_emif_0_avl_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	pcie_hip_avmm_mm_interconnect_5_rsp_mux rsp_mux (
		.clk                 (DUT_coreclkout_clk),                            //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.IN_PKT_BYTE_CNT_L             (612),
		.IN_PKT_TRANS_COMPRESSED_READ  (606),
		.IN_PKT_TRANS_WRITE            (608),
