//altsyncram ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK0" CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_INPUT_B="BYPASS" CLOCK_ENABLE_OUTPUT_B="BYPASS" INTENDED_DEVICE_FAMILY=""Stratix V"" LPM_TYPE="altsyncram" NUMWORDS_A=157286 NUMWORDS_B=39322 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=2 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_BYTEENA_B=1 WIDTH_ECCSTATUS=3 WIDTHAD_A=18 WIDTHAD_B=16 address_a address_b clock0 data_a q_b wren_a
...
module  mgjvj1
	...
	defparam
		...
		mgl_prim1.numwords_a = 157286,
		mgl_prim1.numwords_b = 39322,
		...
		mgl_prim1.widthad_a = 18,
		mgl_prim1.widthad_b = 16;
	assign
		q_b = wire_mgl_prim1_q_b;
endmodule //mgjvj1
//VALID FILE
